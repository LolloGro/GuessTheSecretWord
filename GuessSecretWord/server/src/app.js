...
function loadPages() {
    ...
    let stopTime;
    let wordGuessed = [];
    app.post("/game/secretword/:num/:rep", (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    app.post("/game/highscore/:playerID", (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    app.get("/highscore", (req, res) => __awaiter(this, void 0, void 0, function* () {
        yield mongoose_1.default.connect("mongodb://localhost:27017/highscore");
    ...
    app.get("/game/highscore/number/:num", (req, res) => __awaiter(this, void 0, void 0, function* () {
        yield mongoose_1.default.connect("mongodb://localhost:27017/highscore");
    ...
    app.get("/game/highscore/repeat/:rep", (req, res) => __awaiter(this, void 0, void 0, function* () {
        yield mongoose_1.default.connect("mongodb://localhost:27017/highscore");
        const repeat = req.params.rep;
